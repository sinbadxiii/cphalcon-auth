...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_auth_adapter_stream_getproviderstorage, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(phalcon_auth_adapter_stream_method_entry) {
	...
	PHP_ME(Phalcon_Auth_Adapter_Stream, getProviderStorage, arginfo_phalcon_auth_adapter_stream_getproviderstorage, ZEND_ACC_PROTECTED)
#else
	PHP_ME(Phalcon_Auth_Adapter_Stream, getProviderStorage, NULL, ZEND_ACC_PROTECTED)
#endif
