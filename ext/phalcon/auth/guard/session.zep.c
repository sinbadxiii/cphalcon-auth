...
{
	ZEPHIR_REGISTER_CLASS(Phalcon\\Auth\\Guard, Session, phalcon, auth_guard_session, phalcon_auth_guard_session_method_entry, 0);

	zend_declare_property_null(phalcon_auth_guard_session_ce, SL("nameGuard"), ZEND_ACC_PROTECTED);
	...
	zend_declare_property_null(phalcon_auth_guard_session_ce, SL("di"), ZEND_ACC_PROTECTED);
...
PHP_METHOD(Phalcon_Auth_Guard_Session, __construct)
{
	...
	zval nameGuard;
	zval *adapter, adapter_sub, *config, config_sub, *nameGuard_param = NULL, _0, _2, _3, _4, _6, _7, _9, _10;
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("nameGuard"), &nameGuard);
...
PHP_METHOD(Phalcon_Auth_Guard_Session, recaller)
{
	...
	if (zephir_is_true(&recaller)) {
		...
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 14, &recaller);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Auth_Guard_Session, getName)
{
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("nameGuard"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_1);
	zephir_get_class(&_1, this_ptr, 0);
	ZEPHIR_CALL_FUNCTION(&_2, "sha1", NULL, 15, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_3);
	ZVAL_STRING(&_3, "auth_%s_%s");
	ZEPHIR_RETURN_CALL_FUNCTION("sprintf", NULL, 4, &_3, &_0, &_2);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Auth_Guard_Session, login)
{
	...
	if (remember) {
		...
		if (!(zephir_instance_of_ev(&_3$$3, phalcon_auth_adapter_adapterwithremembertokeninterface_ce))) {
			...
			zephir_read_property(&_5$$4, this_ptr, ZEND_STRL("adapter"), PH_NOISY_CC | PH_READONLY);
			ZEPHIR_INIT_VAR(&_6$$4);
			ZEPHIR_CONCAT_SVS(&_6$$4, "Adapter ", &_5$$4, " not instanceof AdapterWithRememberTokenInterface");
			ZEPHIR_CALL_METHOD(NULL, &_4$$4, "__construct", NULL, 8, &_6$$4);
			zephir_check_call_status();
			zephir_throw_exception_debug(&_4$$4, "phalcon/Auth/Guard/Session.zep", 138);
			ZEPHIR_MM_RESTORE();
			return;
		}
...
PHP_METHOD(Phalcon_Auth_Guard_Session, rememberUser)
{
	...
	if (Z_TYPE_P(&rememberToken) != IS_NULL) {
		...
		ZVAL_STRING(&_8$$3, "U");
		ZEPHIR_CALL_FUNCTION(&_4$$3, "date", NULL, 16, &_8$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Auth_Guard_Session, basicCredentials)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "userfrombasic", NULL, 17, request);
	zephir_check_call_status();
	zephir_array_update_zval(return_value, &field, &_0, PH_COPY);
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "passwordfrombasic", NULL, 18, request);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Auth_Guard_Session, userFromBasic)
{
	...
	ZEPHIR_CALL_METHOD(&_0, request, "getbasicauth", NULL, 0);
	zephir_check_call_status();
	zephir_array_fetch_string(&_1, &_0, SL("username"), PH_NOISY | PH_READONLY, "phalcon/Auth/Guard/Session.zep", 305);
	RETURN_CTOR(&_1);
}
...
PHP_METHOD(Phalcon_Auth_Guard_Session, passwordFromBasic)
{
	...
	ZEPHIR_CALL_METHOD(&_0, request, "getbasicauth", NULL, 0);
	zephir_check_call_status();
	zephir_array_fetch_string(&_1, &_0, SL("password"), PH_NOISY | PH_READONLY, "phalcon/Auth/Guard/Session.zep", 310);
	RETURN_CTOR(&_1);
}
