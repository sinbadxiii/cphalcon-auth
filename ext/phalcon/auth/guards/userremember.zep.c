...
{
	ZEPHIR_REGISTER_CLASS(Phalcon\\Auth\\Guards, UserRemember, phalcon, auth_guards_userremember, phalcon_auth_guards_userremember_method_entry, 0);

	zend_declare_property_null(phalcon_auth_guards_userremember_ce, SL("data"), ZEND_ACC_PROTECTED);
	return SUCCESS;
}
