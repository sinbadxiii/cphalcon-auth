...
{
	ZEPHIR_REGISTER_CLASS(Phalcon\\Auth\\Guards, Session, phalcon, auth_guards_session, phalcon_auth_guards_session_method_entry, 0);

	zend_declare_property_null(phalcon_auth_guards_session_ce, SL("name"), ZEND_ACC_PROTECTED);
	zend_declare_property_null(phalcon_auth_guards_session_ce, SL("session"), ZEND_ACC_PROTECTED);
	zend_declare_property_null(phalcon_auth_guards_session_ce, SL("cookies"), ZEND_ACC_PROTECTED);
	zend_declare_property_null(phalcon_auth_guards_session_ce, SL("eventsManager"), ZEND_ACC_PROTECTED);
	zend_declare_property_null(phalcon_auth_guards_session_ce, SL("request"), ZEND_ACC_PROTECTED);
	zend_declare_property_null(phalcon_auth_guards_session_ce, SL("lastUserAttempted"), ZEND_ACC_PROTECTED);
	zend_declare_property_bool(phalcon_auth_guards_session_ce, SL("viaRemember"), 0, ZEND_ACC_PROTECTED);
	zend_declare_property_null(phalcon_auth_guards_session_ce, SL("provider"), ZEND_ACC_PROTECTED);
	zend_declare_property_null(phalcon_auth_guards_session_ce, SL("di"), ZEND_ACC_PROTECTED);
	zend_declare_property_null(phalcon_auth_guards_session_ce, SL("user"), ZEND_ACC_PROTECTED);
	zend_class_implements(phalcon_auth_guards_session_ce, 1, phalcon_auth_guards_guardinterface_ce);
	zend_class_implements(phalcon_auth_guards_session_ce, 1, phalcon_auth_guards_guardstatefulinterface_ce);
	zend_class_implements(phalcon_auth_guards_session_ce, 1, phalcon_auth_guards_basicauthinterface_ce);
	return SUCCESS;
}
...
PHP_METHOD(Phalcon_Auth_Guards_Session, __construct)
{
	...
	zval *name_param = NULL, *provider, provider_sub, _0, _2, _3, _4, _6, _7, _9, _10;
	zval name;
	...
	ZEPHIR_MM_GROW();
	zephir_fetch_params(1, 2, 0, &name_param, &provider);
...
PHP_METHOD(Phalcon_Auth_Guards_Session, recaller)
{
	...
	if (zephir_is_true(&recaller)) {
		...
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 12, &recaller);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Auth_Guards_Session, getName)
{
	...
	ZEPHIR_CALL_FUNCTION(&_2, "sha1", NULL, 13, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_3);
	ZVAL_STRING(&_3, "auth_%s_%s");
	ZEPHIR_RETURN_CALL_FUNCTION("sprintf", NULL, 6, &_3, &_0, &_2);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Auth_Guards_Session, login)
{
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zend_bool remember;
	zval *user, user_sub, *remember_param = NULL, _0, _1, _2, _7, _3$$3, _4$$4, _5$$4, _6$$4;
	zval *this_ptr = getThis();
	...
	if (remember) {
		ZEPHIR_OBS_VAR(&_3$$3);
		zephir_read_property(&_3$$3, this_ptr, ZEND_STRL("provider"), PH_NOISY_CC);
		if (!(zephir_is_instance_of(&_3$$3, SL("Sinbadxiii\\PhalconAuth\\Adapter\\AdapterWithRememberTokenInterface")))) {
			ZEPHIR_INIT_VAR(&_4$$4);
			object_init_ex(&_4$$4, spl_ce_InvalidArgumentException);
			zephir_read_property(&_5$$4, this_ptr, ZEND_STRL("provider"), PH_NOISY_CC | PH_READONLY);
			ZEPHIR_INIT_VAR(&_6$$4);
			ZEPHIR_CONCAT_SVS(&_6$$4, "Adapter ", &_5$$4, " not instanceof AdapterWithRememberTokenInterface");
			ZEPHIR_CALL_METHOD(NULL, &_4$$4, "__construct", NULL, 14, &_6$$4);
			zephir_check_call_status();
			zephir_throw_exception_debug(&_4$$4, "phalcon/Auth/Guards/Session.zep", 137);
			ZEPHIR_MM_RESTORE();
			return;
		}
	...
	ZEPHIR_CALL_METHOD(NULL, &_7, "fire", NULL, 0, &_1, this_ptr);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Auth_Guards_Session, rememberUser)
{
	...
	if (Z_TYPE_P(&rememberToken) != IS_NULL) {
		...
		ZVAL_STRING(&_8$$3, "U");
		ZEPHIR_CALL_FUNCTION(&_4$$3, "date", NULL, 15, &_8$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Auth_Guards_Session, basicCredentials)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "userfrombasic", NULL, 16, request);
	zephir_check_call_status();
	zephir_array_update_zval(return_value, &field, &_0, PH_COPY);
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "passwordfrombasic", NULL, 17, request);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Auth_Guards_Session, userFromBasic)
{
	...
	ZEPHIR_CALL_METHOD(&_0, request, "getbasicauth", NULL, 0);
	zephir_check_call_status();
	zephir_array_fetch_string(&_1, &_0, SL("username"), PH_NOISY | PH_READONLY, "phalcon/Auth/Guards/Session.zep", 304);
	RETURN_CTOR(&_1);
}
...
PHP_METHOD(Phalcon_Auth_Guards_Session, passwordFromBasic)
{
	...
	ZEPHIR_CALL_METHOD(&_0, request, "getbasicauth", NULL, 0);
	zephir_check_call_status();
	zephir_array_fetch_string(&_1, &_0, SL("password"), PH_NOISY | PH_READONLY, "phalcon/Auth/Guards/Session.zep", 309);
	RETURN_CTOR(&_1);
}
